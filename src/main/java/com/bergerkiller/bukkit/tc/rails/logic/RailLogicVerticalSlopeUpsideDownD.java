...
/**
 * Handles rail logic of an upside-down slope with a vertical rail both below and above it.<br>
 * <br>
...
public class RailLogicVerticalSlopeUpsideDownD extends RailLogicVerticalSlopeBase {
    ...
    protected RailPath createPath() {
        ...
        Vector p1 = new Vector(dx, Y_POS_OFFSET_UPSIDEDOWN + Y_POS_OFFSET_UPSIDEDOWN_SLOPE, dz);
