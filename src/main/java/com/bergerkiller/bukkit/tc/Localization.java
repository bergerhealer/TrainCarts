...
public class Localization extends LocalizationEnum {
    ...
    public static final Localization PROPERTY_NOPERM = new Localization("property.nopermission", ChatColor.RED + "You do not have permission to modify property with name '%0%'");
